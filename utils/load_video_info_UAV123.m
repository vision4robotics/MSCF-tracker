...
function seq = load_video_info_UAV123(video_name, database_folder, ground_truth_path, type)
    ...
    switch type
        case 'UAV123_10fps'
            seqs = configSeqs_UAV123(database_folder, type);       % database_folder是包含了所有数据集的文件夹
        case 'UAV123'
            seqs = configSeqs_UAV123(database_folder, type);       % type: UAV123_10fps, UAV123, UAV123_20L
        case 'UAV123_20L'
            seqs = configSeqs_UAV123(database_folder, type);
    end
