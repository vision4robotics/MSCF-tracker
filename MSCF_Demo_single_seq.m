...
%   This script runs the implementation of MSCF for visual tracking.
%   Some functions are borrowed from other papers (ARCF, SRDCF, UAV123 Benchmark)
...
for idxSeq=1:length(seqs)
    ...
    %   Run MSCF main function
    res = run_MSCF(subS, 0, 0);
